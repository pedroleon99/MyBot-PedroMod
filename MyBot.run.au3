...
$sModVersion = "PedroMod" ;- Adding Mod Version
...
; Update Bot title
$sBotTitle = $sBotTitle & $sModVersion & "(" & ($AndroidInstance <> "" ? $AndroidInstance : $Android) & ")" ;Do not change this. If you do, multiple instances will not work.
