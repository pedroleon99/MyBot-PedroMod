...
$x = 0
$y += 5
$lbltopgoldloot = GUICtrlCreateLabel("Best", $x + 90, $y, 60, 17, $SS_LEFT)
GUICtrlSetFont(-1, 11.5, $FW_BOLD, Default, "arial", $CLEARTYPE_QUALITY)
GUICtrlSetColor(-1, 0x000000)
GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
$lbltopelixirloot = GUICtrlCreateLabel("Loot", $x + 160, $y, 60, 17, $SS_LEFT)
GUICtrlSetFont(-1, 11.5, $FW_BOLD, Default, "arial", $CLEARTYPE_QUALITY)
GUICtrlSetColor(-1, 0x000000)
GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
$lbltopdarkloot = GUICtrlCreateLabel("Here", $x + 230, $y, 50, 17, $SS_LEFT)
GUICtrlSetFont(-1, 11.5, $FW_BOLD, Default, "arial", $CLEARTYPE_QUALITY)
GUICtrlSetColor(-1, 0x000000)
GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
