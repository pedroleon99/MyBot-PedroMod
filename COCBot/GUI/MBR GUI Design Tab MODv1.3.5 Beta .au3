...
$tabMOD = GUICtrlCreateTabItem("Mods")
	...
	;$x -= 10
		...
		$Account = GUICtrlCreateInput("2", $x +170, $y -7, 15, 15, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetLimit(-1, 4)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$lblmultyAcc = GUICtrlCreateLabel(GetTranslated(17,2, "How Many:"), $x +100, $y -5, -1, -1)
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$lblmultyAccBtn = GUICtrlCreateLabel(GetTranslated(17, 20, "Fast Switch:"), $x +100, $y +18, -1, -1)
			$txtTip = GetTranslated(17, 21, "Fast switch between accounts")
			GUICtrlSetTip(-1, $txtTip)
		$btnmultyAcc1 = GUICtrlCreateButton("#1", $x + 170, $y +13, -1, -1)
			$txtTip = GetTranslated(17,22, "Change to Main Account")
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "btnmultyAcc1")
			GUICtrlSetState(-1, $GUI_DISABLE)			
		$btnmultyAcc2 = GUICtrlCreateButton("#2", $x + 200, $y +13, -1, -1)
			$txtTip = GetTranslated(17,23, "Change to Second Account")
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "btnmultyAcc2")
			GUICtrlSetState(-1, $GUI_DISABLE)	
		$btnmultyAcc3 = GUICtrlCreateButton("#3", $x + 230, $y +13, -1, -1)
			$txtTip = GetTranslated(17,24, "Change to Third Account")
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "btnmultyAcc3")
			GUICtrlSetState(-1, $GUI_DISABLE)	
		$btnmultyAcc4 = GUICtrlCreateButton("#4", $x + 260, $y +13, -1, -1)
