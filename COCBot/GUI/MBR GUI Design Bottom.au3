...
$grpVillage = GUICtrlCreateGroup(GetTranslated(13,21, "Village"), $x - 20, $y - 20, 190, 85)
	...
	$lblResultGoldHourNow = GUICtrlCreateLabel("-", $x, $y + 2, 50, 15, $SS_RIGHT)
		GUICtrlSetState(-1, $GUI_HIDE)
	$lblResultGoldTop = GUICtrlCreateLabel("-", $x, $y + 2, 50, 15, $SS_RIGHT)
		GUICtrlSetState(-1, $GUI_HIDE)		
	...
	$lblResultElixirHourNow = GUICtrlCreateLabel("-", $x, $y + 22, 50, 15, $SS_RIGHT)
		GUICtrlSetState(-1, $GUI_HIDE)
	$lblResultElixirTop = GUICtrlCreateLabel("-", $x, $y + 22, 50, 15, $SS_RIGHT)
		GUICtrlSetState(-1, $GUI_HIDE)
	...
	$lblResultDEHourNow = GUICtrlCreateLabel("-", $x - 5, $y + 42, 55, 15, $SS_RIGHT)
		GUICtrlSetState(-1, $GUI_HIDE)
	$lblResultDETop = GUICtrlCreateLabel("-", $x - 5, $y + 42, 55, 15, $SS_RIGHT)
		GUICtrlSetState(-1, $GUI_HIDE)
	...
	$lblResultRuntimeNow = GUICtrlCreateLabel("-", $x, $y + 2, 50, 15, $SS_RIGHT)
	GUICtrlSetState(-1, $GUI_HIDE)
	$picResultRuntimeNow = GUICtrlCreateIcon($pIconLib, $eIcnHourGlass, $x +57, $y, 16, 16)
	GUICtrlSetState(-1, $GUI_HIDE)
	$lblResultTrophyTop = GUICtrlCreateLabel("-", $x, $y + 2, 50, 15, $SS_RIGHT)
	GUICtrlSetState(-1, $GUI_HIDE)
	;builders / attacked / DE drills zapped
	...
	$lblResultAttackedHourNow = GUICtrlCreateLabel("-", $x, $y + 22, 50, 15, $SS_RIGHT)
	GUICtrlSetState(-1, $GUI_HIDE)
	$picResultAttackedHourNow = GUICtrlCreateIcon($pIconLib, $eIcnBldgTarget, $x +59, $y + 20, 16, 16)
	GUICtrlSetState(-1, $GUI_HIDE)
	$lblResultDEDrillZapTop = GUICtrlCreateLabel("-", $x, $y + 22, 50, 15, $SS_RIGHT)
	GUICtrlSetColor(-1, 0x279B61)
	GUICtrlSetState(-1, $GUI_HIDE)
	$picResultDEDrillZapTop = GUICtrlCreateIcon($pIconLib, $eIcnDrill, $x +59, $y + 20, 16, 16)
	GUICtrlSetState(-1, $GUI_HIDE)	
	;gems / skipped / Spells used Zap
	...
	$lblResultSkippedHourNow = GUICtrlCreateLabel("-", $x, $y + 42, 50, 15, $SS_RIGHT)
	GUICtrlSetState(-1, $GUI_HIDE)
	$picResultSkippedHourNow = GUICtrlCreateIcon ($pIconLib, $eIcnBldgX, $x + 59, $y + 40, 16, 16)
	GUICtrlSetState(-1, $GUI_HIDE)
	$lblResultLSpellTop = GUICtrlCreateLabel("-", $x, $y + 42, 50, 15, $SS_RIGHT)
	GUICtrlSetColor(-1, 0x279B61)
	GUICtrlSetState(-1, $GUI_HIDE)
