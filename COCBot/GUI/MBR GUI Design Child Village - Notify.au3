...
$hGUI_NOTIFY_TAB_ITEM1 = GUICtrlCreateTabItem(GetTranslated(600,18,"PushBullet/Telegram"))
	...
	Local $x = 25, $y = 45
		...
		$PushBulletTokenValue = GUICtrlCreateInput("", $x + 120, $y - 3, 280, 19)
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
		;Modified by CDudz
		$lblTelegramTokenValue = GUICtrlCreateLabel(GetTranslated(619, 39, "Telegram Token") & ":", $x, $y + 28, -1, -1, $SS_RIGHT)
		$TelegramTokenValue = GUICtrlCreateInput("", $x + 120, $y + 25, 280, 19)
		GUICtrlSetState(-1, $GUI_DISABLE)

		$y += 30
		$lblOrigPushBullet = GUICtrlCreateLabel(GetTranslated(619, 16, "Origin") & ":", $x + 195, $y + 22, -1, -1, $SS_RIGHT)
			$txtTip = GetTranslated(619,17, "Your Profile/Village name - Set this on the Misc Tab under Profiles.")
			_GUICtrlSetTip(-1, $txtTip)
		$OrigPushBullet = GUICtrlCreateInput("", $x + 240, $y + 20, 160, 19, $ES_CENTER)
			_GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetState(-1, $GUI_DISABLE)
		;$y += 25
		$y += 55
