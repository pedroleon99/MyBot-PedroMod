; #FUNCTION# ====================================================================================================================
; Name ..........: ChatBot
; Description ...: This file contains all functions of ChatBot feature v1.6.4
; Syntax ........: ---
; Parameters ....: ---
; Return values .: ---
; Author ........: rulesss, Дмитрий Степанов, TheRevenor
; Modified ......: 03/09/2016
...
Func ChatbotCreateGui()
	...
	$x = 20
	$y -= 5
	$chkGlobalChat = GUICtrlCreateCheckbox(GetTranslated(106, 3, "Advertise in global"), $x - 5, $y)
	...
	$y += 18
	$chkGlobalScramble = GUICtrlCreateCheckbox(GetTranslated(106, 5, "Scramble global chats"), $x - 5, $y)
	...
	GUICtrlSetOnEvent(-1, "ChatGuiCheckboxUpdate")
	$y += 18
	$chkSwitchLang = GUICtrlCreateCheckbox(GetTranslated(106, 7, "Switch languages"), $x - 5, $y)
	...
	$x = 240
	$y -= 5
	$chkClanChat = GUICtrlCreateCheckbox(GetTranslated(106, 16, "Chat in clan chat"), $x - 5, $y)
	...
	GUICtrlSetOnEvent(-1, "ChatGuiCheckboxUpdate")
	$y += 18
	$chkUseCleverbot = GUICtrlCreateCheckbox(GetTranslated(106, 20, "Use cleverbot responses"), $x - 5, $y)
	_GUICtrlSetTip($chkUseCleverbot, GetTranslated(106, 21, "Get responses from cleverbot.com"))
	GUICtrlSetState($chkUseCleverbot, $ChatbotClanUseCleverbot)
	GUICtrlSetOnEvent(-1, "ChatGuiCheckboxUpdate")
	$y += 18
	$chkUseSimsimi = GUICtrlCreateCheckbox(GetTranslated(106, 22, "Use simsimi responses"), $x - 5, $y)
	_GUICtrlSetTip($chkUseSimsimi, GetTranslated(106, 23, "Get responses from simsimi.com"))
...
#cs ----------------------------------------------------------------------------
	...
	Author:         ChrisDuh
	; Chatbot script fixed by rulesss,Дмитрий Степанов,TheRevenor
