...
EndFunc   ;==>InitDonateStats

Func CompareBitmaps($File1, $File2)
	...
	Global $BitmapData1 = _GDIPlus_BitmapLockBits($pBitmap1, 0, 0, _GDIPlus_ImageGetWidth($pBitmap1), _GDIPlus_ImageGetHeight($pBitmap1), $GDIP_ILMWRITE, $GDIP_PXF32RGB)
	Global $BitmapData2 = _GDIPlus_BitmapLockBits($pBitmap2, 0, 0, _GDIPlus_ImageGetWidth($pBitmap2), _GDIPlus_ImageGetHeight($pBitmap2), $GDIP_ILMWRITE, $GDIP_PXF32RGB)

	Global $Stride1 = DllStructGetData($BitmapData1, "Stride")
	Global $Stride2 = DllStructGetData($BitmapData2, "Stride")

	Global $Width1 = DllStructGetData($BitmapData1, "Width")
	Global $Width2 = DllStructGetData($BitmapData2, "Width")

	Global $Height1 = DllStructGetData($BitmapData1, "Height")
	Global $Height2 = DllStructGetData($BitmapData2, "Height")

	Global $PixelFormat1 = DllStructGetData($BitmapData1, "PixelFormat")
	Global $PixelFormat2 = DllStructGetData($BitmapData2, "PixelFormat")

	Global $Scan01 = DllStructGetData($BitmapData1, "Scan0")
	Global $Scan02 = DllStructGetData($BitmapData2, "Scan0")

	Global $TotalPixels = $Width1 * $Height1
	Global $RemainingPixels = $TotalPixels
